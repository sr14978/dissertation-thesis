...
During this thesis, I explore the analysis techniques that can be used to distinguish traffic produced using an FTE proxy from normal traffic.
...
To keep the distribution description manageable, I am forced to approximate it to several heuristic based measures. 
