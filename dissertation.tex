...
However, these weights would not be meaningful, since they would not be taking into consideration the previous path through the transition graph and therefore previous symbols in the stream.
...
Large amounts of data are needed to train the system, where, if we desire practical performance, specialist hardware will be required to cope with the parallelism. Although, in the not so distant future this may become ubiquitous.
